    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} >
                ...
                <p><small>Note: Feature requests are sent to all active developers and are integrated into our roadmap whereever possible. If the development team has questions about your request, they will contact you at the email associated with your account. If you have any questions or concerns please contact the project lead, Justin at cervantes.jfa@gmail.com</small></p>
